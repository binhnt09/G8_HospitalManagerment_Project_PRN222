...
namespace G8_HospitalManagerment_Project_PRN222.Controllers.BillingController
{
    public class InvoicesController : Controller
    {
        ...
        {
            var dbHospitalManagementContext = _context.Invoices.Include(i => i.Appointment).Include(i => i.Patient);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,PatientId,AppointmentId,TotalAmount,Discount,FinalAmount,Status,IssueDate,CreatedAt,UpdatedAt,DeletedAt,IsDeleted")] Invoice invoice)
        {
